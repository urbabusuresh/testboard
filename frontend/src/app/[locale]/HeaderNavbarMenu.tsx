...
export default function HeaderNavbarMenu({ messages, locale }: Props) {
  ...
  if (Config.isDemoSite) {
    commonLinks.push(
      {
        uid: 'docs',
        href: 'https://raptr.github.io/TestLab/docs/getstarted/selfhost',
        label: messages.docs,
        isExternal: true,
      },
      {
        uid: 'roadmap',
        href: 'https://raptr.github.io/TestLab/docs/roadmap/',
  ...
  return (
    <Navbar isMenuOpen={isMenuOpen} maxWidth="full" position="sticky" className="bg-gradient-to-br from-blue-100 via-purple-50 to-blue-100" >
      <NavbarContent className="basis-1/5 sm:basis-full" justify="start">
        <NavbarBrand as="li" className="gap-3 max-w-fit">
          <Link className="flex justify-start items-center gap-1" href="/" locale={locale}>
            ...
            <p className="font-bold text-inherit ms-1">TestLab</p>
          </Link>
        </NavbarBrand>
