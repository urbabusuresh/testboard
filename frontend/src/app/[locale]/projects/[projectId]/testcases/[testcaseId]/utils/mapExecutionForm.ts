...
export function mapFormToUpsert(
  ...
  ids: { 
    ...
    testcase_id: number;
    projectId: number;
    execution_state?: number; // Add this
  }
  ...
  const statusMap: Record<string, string> = {
    ...
    enhancement: "Enhancement/Revised",
  };
  ...
  return {
    ...
    // Execution state - prioritize ids.execution_state (from button actions), fallback to form
    ...
    approver_comments: form.approverComments || null,
    ...
    enhanced_test_case_id: form.enhanced_test_case_id || null,
  };
}
