...
export default function RunsPage({ projectId, locale, messages }: Props) {
  ...
  return (
    <div className="container bg-orange-50 rounded  w-full h-full p-1">
      <div className="w-full p-1 flex items-center  justify-between">
        <div className="font-medium"><strong>{messages.runList} - </strong>Create Testing Runs for project sprint accordingly</div>
        <div>
          <Button
