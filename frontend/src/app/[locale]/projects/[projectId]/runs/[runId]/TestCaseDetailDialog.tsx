...
import { testTypes, templates, automationStatus ,testCaseIntent} from '@/config/selection';
        ...
        <ModalBody>
          ...
          <div className="flex my-2">
            ...
            <div className="w-1/2">
             ...
             <div className="w-1/2">
              <p className={'font-bold'}>Test Case Intent</p>
              <div>{[testCaseIntent[testCase.caseType].uid.toUpperCase()]}</div>
            </div>

             <div className="w-1/2">
              <p className={'font-bold'}>Automation Status</p>
              <div>{[automationStatus[testCase.automationStatus].uid.toUpperCase()]}</div>
            </div>
